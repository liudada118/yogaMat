      ...
      if (!error) {
        ...
        ws.onmessage = (e) => {
          ...
          if (inputArr.length == 0) {
            //这里是预测结果
            // if (jsonObject.analysisMap.area == '深坐' || jsonObject.analysisMap.area == '中间') {
            //   if (jsonObject.analysisMap.pose == '前倾') {
            //     this.props.changeImg([1, 0, 0])
            //     this.props.img1.current.viewConfig.NativeProps.opacity = 1
            //     this.props.img2.current.viewConfig.NativeProps.opacity = 0
            //     this.props.img3.current.viewConfig.NativeProps.opacity = 0
            //   } else {
            //     this.props.img1.current.viewConfig.NativeProps.opacity = 0
            //     this.props.img2.current.viewConfig.NativeProps.opacity = 1
            //     this.props.img3.current.viewConfig.NativeProps.opacity = 0
            //   }
            // } else {
            //   this.props.img1.current.viewConfig.NativeProps.opacity = 0
            //   this.props.img2.current.viewConfig.NativeProps.opacity = 0
            //   this.props.img3.current.viewConfig.NativeProps.opacity = 1
            // }
            this.props.changeState({
              seating: jsonObject.analysisMap.area,
              seatHeight: jsonObject.analysisMap.balance,
              badSeat: jsonObject.analysisMap.leg,
              body: jsonObject.analysisMap.pose,
            });
            // this.props.changeSeat(jsonObject.analysisMap.area)
          } else {
